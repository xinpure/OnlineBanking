...
<div>
	<form:form action="password" class="login" onsubmit="return validateLogin()">   
    ...
    <input type="password" name="password" id="new-password" class="login-input" placeholder="New Password" onfocus="clearTD('new-passwordTD')">
